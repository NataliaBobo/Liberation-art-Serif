...
const wellnessEvents = [
  {
    ...
    description:
      "Hands-on painting, drawing, and collage experiences that invite people to express emotions, reflect, and heal through creative action.",
  },
  {
    ...
    description:
      "Breathwork, grounding exercises, and reflective practices designed to reduce stress and help participants reconnect with their inner calm.",
  },
  {
    ...
    description:
      "Creative performances, spoken word, and music-led experiences that encourage joy, release, and collective healing.",
  },
  {
    ...
    description:
      "Supportive discussion circles that foster belonging, storytelling, and emotional connection through shared human experience.",
  },
];
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Immersive celebration of art, healing and community connection.
              We create spaces where people can breathe, reflect, and reconnect
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-1xl md:text-4xl font-italics font-serif mb-3">
                    {event.title}
                  </h3>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  Express your emotions through colors and brushstrokes in this
                  guided outdoor painting session surrounded by nature.
                </p>

                <div className="mt-5 flex flex-wrap gap-2">
                  {["Art therapy", "Painting"].map((activity) => (
                    <span
                      key={activity}
                      className="rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-xs font-medium text-primary"
                    >
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  A peaceful, restorative escape that blends creativity,
                  reflection, and stillness for a deeper sense of balance and
                  renewal.
                </p>

                <div className="mt-5 flex flex-wrap gap-2">
                  {["Art session", "Journaling", "Meditation"].map(
                    (activity) => (
                      <span
                        key={activity}
                        className="rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-xs font-medium text-primary"
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  A grounding rhythm experience that invites participants to
                  release stress, reconnect with their breath, and find calm
                  through shared drumming and sound healing.
                </p>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  A vibrant wildlife-inspired creative retreat where
                  participants connect with the landscape through observation,
          ...
          <div className="mt-12 rounded-[2rem] border border-primary/20 bg-gradient-to-r from-primary/10 via-background to-background p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold font-serif">
                Bring wellness into your next celebration.
              </h3>
